...
$GLOBALS['translations'] = array_merge(
    ...
    array(
        ...
        'LMS_ACTIVITY_SCRIPTING' => 'Scénarisation des activités',
        'LMS_MODULE_SCRIPTING' => 'Scénarisation des modules',
        ...
        'LMS_MODULE_PREVIEW_NOT_POSSIBLE' => 'Pas accessible tant que vous n\'avez pas commencé le module ',
        'LMS_ACTIVITY_PREVIEW_NOT_POSSIBLE' => 'Pas accessible tant que vous n\'avez pas commencé l\'activité ',
        ...
        'LMS_EXTRA_ACTIVITY_CREATE_ATTENDANCE_SHEET' => 'Créer une feuille d\'émargement',
        ...
        'EDIT_CONFIG_HINT_LMS_CONFIG[SAVE_PROGRESS_FOR_ADMINS]' => 'Sauvegarder la progression des adminstrateurs⋅ices (true/false)',
        ...
        'EDIT_CONFIG_HINT_LMS_CONFIG[PROGRESS_DASHBOARD_FILTERS]' => 'Liste de champs de l\'apprenant sur lesquels on filtre le tableau de bord des progressions (noms de champs séparés par des «,»)',
    )
);
